  ...
  <div class="gvb_footer">
    <div class="gvb_footer_container">
      <div class="left">
        ...
        <div class="date">
          <span class="create_site_date">建站日期：{{ dateFormat(store.siteInfo.created_at) }}</span>
          <span class="site_running_date">网站已运行: {{ countDown }}</span>
        </div>
        <div class="beian">
          <img src="/image/icon/beian.png" alt="">
          <a href="https://beian.miit.gov.cn/#/Integrated/index" target="_blank">备案号：{{ store.siteInfo.bei_an }}</a>
        </div>
      </div>
      <div class="right">
        ...
        <a :href="store.siteInfo.github_url" target="_blank"><img src="/image/icon/github.png" alt=""></a>
      </div>
    </div>
  </div>
</template>
