...
onMounted(() => {
  ...
  let charts_color1 = getComputedStyle(document.body).getPropertyValue("--charts_color1")
  let charts_color2 = getComputedStyle(document.body).getPropertyValue("--charts_color2")
  let color_text_1 = getComputedStyle(document.body).getPropertyValue("--color-text-1")
