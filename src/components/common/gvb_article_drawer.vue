<template>
  <div class="gvb_article_drawer">
    <gvb_article_update v-model:visible="updateVisible" :data="data" title="文章信息" type="add"
                        @ok="okHandler"></gvb_article_update>

    <a-drawer class="gvb_article_drawer_inner" width="86%" :visible="props.visible"
