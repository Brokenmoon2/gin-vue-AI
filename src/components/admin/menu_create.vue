      ...
      <a-form ref="formRef" :model="form">
        ...
        <a-form-item label="简介">
          <a-textarea
              ...
              placeholder="简介"
              :auto-size="{minRows:2,maxRows: 2}"></a-textarea>
        </a-form-item>
        <a-form-item label="bannerT">
          <a-input-number v-model="form.banner_time" placeholder="banner切换时间"></a-input-number>
          <template #extra>
            <div>banner图的切换时间</div>
          </template>
        </a-form-item>
        <a-form-item label="abstractT">
          <a-input-number v-model="form.abstract_time" placeholder="简介切换时间"></a-input-number>
          <template #extra>
            <div>简介内容的切换时间</div>
          </template>
        </a-form-item>
        <a-form-item label="序号">
          <a-input-number v-model="form.sort" placeholder="序号"></a-input-number>
          <template #extra>
            <div>序号大的在前面</div>
          </template>
        </a-form-item>
