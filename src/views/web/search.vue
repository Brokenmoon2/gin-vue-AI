    ...
    <main>
      <div class="container">
        <div class="head">
          ...
          <a-input class="search_ipt" v-model="params.key" @keydown.enter="getData"
        ...
        <div class="action">
          ...
          <div class="item">
            <span @click="checkKey('category', item)" :class="{active: params.category === item.value}"
...
import type {articleParamsType, articleType} from "@/api/article_api";
